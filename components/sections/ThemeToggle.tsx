...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="relative z-50 flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-full shadow-md bg-white text-black transition-transform duration-300 ease-in-out hover:scale-105 focus:outline-none"
